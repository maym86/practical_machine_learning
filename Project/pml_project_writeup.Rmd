...
Validation
----------------
The validation data is then used with the model. The confusion matrix estimates the performance of the model on new data. This returns a highly accurate result and therefore indicates that Random Forest may be a good model for predicting this data as it has an accuracy of 99.6%.
